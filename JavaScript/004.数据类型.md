- [数据类型](#数据类型)
    - [4.1 typeof 运算符](#4.1-typeof-运算符)
    - [4.2 Undefined 类型](#4.2-undefined-类型)
    - [4.3 Null 类型](#4.3-null-类型)
    - [4.4 Boolean 类型](#4.4-boolean-类型)
    - [4.5 Number 类型](#4.5-number-类型)
        - [4.5.1 进制](#4.5.1-进制)
        - [4.5.2 浮点类型](#4.5.2-浮点类型)
        - [4.5.3 NaN](#4-5-3-nan)
        - [4.5.4 数值转换](#4.5.4-数值转换)
            - [4.5.4.1 Number()](#4-5-4-1-number)
            - [4.5.4.2 parseInt()](#4-5-4-2-parseint)
            - [4.5.4.3 parseFloat ()](#4-5-4-3-parsefloat)
    - [4.6 String 类型](#4.6-string-类型)
    - [4.7 Object 类型](#4.7-object-类型)
